...
*  Copyright notice
*
*  (c) 2006 Daniel Regelein (Daniel.Regelein@diehl-informatik.de)
*  All rights reserved
*
...
class ux_SC_alt_doc extends SC_alt_doc {
	...
	function processData() {
		...
		if ( (int)$GLOBALS['typoVersion'] >= 4000000 ) {
			$this->processData_40();
		} else /*if ( (int)$GLOBALS['typoVersion'] < 4000000 )*/ {
			$this->processData_38();
		}
	}
	
	
	function processData_38() {
